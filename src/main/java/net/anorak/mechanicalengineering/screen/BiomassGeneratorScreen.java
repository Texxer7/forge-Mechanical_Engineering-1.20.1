...
public class BiomassGeneratorScreen extends AbstractContainerScreen<BiomassGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MechanicalEngineering.MOD_ID, "textures/gui/biomass_generator_gui.png");
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            guiGraphics.blit(TEXTURE, x + 76, y + 30, 176, 0, menu.getScaledProgress(), 16);
        }
    }
